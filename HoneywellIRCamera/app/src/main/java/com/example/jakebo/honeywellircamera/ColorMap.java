...
public class ColorMap {
    ...
    public void SetMinMaxValue(short minValue, short maxValue) {
        minRawValue = minValue;
        maxRawValue = maxValue;
    }

    private int[] SelectColormapArray(int colorType) {
        int[] colormapArray;

        switch (colorType) {
            case COLOR_IRONBLACK:
                colormapArray = colormap_ironblack;
                break;

            case COLOR_GRAY:
                colormapArray = colormap_grayscale;
                break;

            case COLOR_RAINBOW:
                colormapArray = colormap_rainbow;
                break;
